...
public class Cavaleiro extends Heroi {
    public Cavaleiro(String nome, int vidaMax, int vidaAtual, int forca, ArmaPrincipal armaPrincipal, int ouro, int nivel) {
    ...
    public void atacar(NPC npc) {
        ...
        while (npc.vidaAtual > 0 && this.vidaAtual > 0) {
            ...
            while (npc.vidaAtual > 0 && this.vidaAtual > 0) {
                ...
                double novoDano = (double) npc.forca * 0.2;
                double danoReducao = npc.forca - novoDano;
                this.vidaAtual -= danoReducao;
                System.out.println(npc.nome + " atacou o " + this.nome + " e perdeu " + danoReducao + " pontos de vida!");
                ...
                if (this.vidaAtual > 0) {
                    do {
                        ...
                        try {
                            escolhaCombate = scanner.nextInt();
                            if (escolhaCombate < 1 || escolhaCombate > 3) {
                    ...
                    } while (escolhaCombate < 1 || escolhaCombate > 3);
                    switch (escolhaCombate) {
                            ...
                            while (!atacou) {
                                do {
                                    ...
                                    try {
                                        ...
                                        if (escolhaAtacar < 1 || escolhaAtacar > 2) {
                                ...
                                } while (escolhaAtacar < 1 || escolhaAtacar > 2);
                            ...
                            if (this.inventario.isEmpty()) {
                                ...
                                do {
                                    ...
                                    try {
                                        ...
                                        if (escolhaConsumivel < 1 || escolhaConsumivel > this.inventario.size()) {
                                            System.out.println("\nIntroduza um número entre 1 a " + this.inventario.size() + "!");
                                            pressionaEnter();
                                        }
                                    } catch (InputMismatchException e) {
                                        System.out.println("\nPor favor, introduza um número válido!");
                                ...
                                } while (escolhaConsumivel < 1 || escolhaConsumivel > this.inventario.size());
                        ...
                        case 3:
                            ...
                            if (!possuiConsumivelCombate) {
                                ...
                                } while (escolhaAtacar < 1 || escolhaConsumivel > this.inventario.size());
                                if (escolhaConsumivel > 0 && escolhaConsumivel <= this.inventario.size()) {
