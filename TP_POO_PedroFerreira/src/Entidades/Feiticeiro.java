...
public class Feiticeiro extends Heroi {
    public Feiticeiro(String nome, int vidaMax, int vidaAtual, int forca, ArmaPrincipal armaPrincipal, int ouro, int nivel) {
    ...
    public void atacar(NPC npc) {
        ...
        while (npc.vidaAtual > 0 && this.vidaAtual > 0) {
            ...
            if (npc.vidaAtual > 0) {
                ...
                this.vidaAtual -= npc.forca;
                System.out.println(npc.nome + " atacou o " + this.nome + " e perdeu " + npc.forca + " pontos de vida!");
